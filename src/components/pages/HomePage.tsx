  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
      ...
      <button
        ...
        className="w-full text-white py-3 sm:py-4 rounded-lg font-bold text-base sm:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px] shadow-md hover:shadow-lg hover:scale-105 border-2 border-primary/20"
...
export default function HomePage() {
  ...
  return (
    <div className="bg-white min-h-screen w-full overflow-clip font-sans text-charcoal-black selection:bg-warm-cream selection:text-charcoal-black m-0 p-0">
      ...
      <section className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-hidden h-auto min-h-[500px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-[800px] m-0 p-0 -mt-20 sm:-mt-24 md:-mt-32 pt-20 sm:pt-24 md:pt-32" style={{ backgroundColor: '#986A6C', background: 'linear-gradient(to right, #986A6C 95%, #986A6C)' }}>
