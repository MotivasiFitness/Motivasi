...
function Header() {
  ...
  // Header is transparent, use white text for visibility
  ...
  return (
    <header 
      className="sticky top-0 z-40 safe-area-top m-0 p-0 backdrop-blur-md bg-transparent"
    >
      <div className={`max-w-[100rem] mx-auto px-3 sm:px-4 md:px-6 lg:px-20 m-0 p-0`}>
        <div className="flex items-center justify-center h-20 sm:h-24 md:h-32 relative">
          ...
          <div className="hidden md:flex items-center gap-3 lg:gap-6 absolute right-0 h-full pr-4 lg:pr-6">
            {isAuthenticated ? (
              <>
                {isTrainer ? (
                  <Link 
        ...
        {isMenuOpen && (
          <nav className="md:hidden py-3 border-t border-gray-700 bg-black/20 backdrop-blur-md relative z-10">
            <div className="flex flex-col gap-1">
              <Link 
                to="/online-training" 
                className="font-paragraph text-base text-white hover:text-gray-200 transition-colors duration-200 px-4 py-3 rounded min-h-[44px] flex items-center"
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <button
                    ...
                    className="font-paragraph text-base text-white hover:text-gray-200 transition-colors duration-200 flex items-center gap-2 px-4 py-3 rounded min-h-[44px] w-full text-left"
                  >
                ...
                <button 
                  ...
                  className="font-paragraph text-base text-black border-2 border-white bg-white px-4 py-3 rounded-lg hover:bg-gray-200 transition-all duration-200 font-semibold text-center w-full min-h-[44px]"
                >
                  Client Portal
                </button>
              )}
